...
import { Settings, Keyboard, MousePointer, Info } from 'lucide-react';
    ...
    <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div style={{ marginTop: 8 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginTop: 4 }}>
          Application preferences and developer configuration
        </p>
      </div>
        ...
        <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
          <button
            ...
            style={{
              ...
              fontSize: 13,
              fontWeight: 500,
              backgroundColor: inputMode === 'selection' ? 'rgba(0, 229, 255, 0.15)' : 'rgba(255, 255, 255, 0.04)',
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13,
              fontWeight: 500,
              backgroundColor: inputMode === 'keyboard' ? 'rgba(0, 229, 255, 0.15)' : 'rgba(255, 255, 255, 0.04)',
